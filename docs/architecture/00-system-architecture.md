...
| 字段 | 值 |
|---|---|
| 文档版本 | 2.0 (2026-08-24 — 范式转换:Agent 运行时作为可变因素,引入 L0/L1 抽象层,文档 1.3 → 2.0) |
| 文档状态 | active |
...
**L2 组件建设状态**: **7 个组件四件套齐备** + 沙箱隔离(基础设施层能力,无独立 DESIGN.md)。
...
| 7 个 L2 组件四件套齐备 + 沙箱隔离 | 已上线 | ✅ |
| 12 份 ADR accepted | 已上线 | ✅ |
| 上下文溢出防护状态机 | 已上线 | ✅ |
| 运行时抽象层(L1) | 已上线 | ✅ |
