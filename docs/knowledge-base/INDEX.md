...
> 来源：110 篇 Markdown（ADR-003 §4.3 — Markdown 是唯一来源）。
...
`contract-management`(19) · `project-management`(13) · `role`(11) · `clm`(9) · `identity`(9) · `architecture`(7) · `openclaw`(6) · `capabilities`(5) · `workflow`(5) · `methodology`(5) · `knowledge-base`(5) · `l3`(4) · `soul`(4) · `microservices`(4) · `secretref`(4) · `monitoring`(3) · `compliance`(3) · `legal`(3) · `agents`(3) · `legal-reviewer`(3) · `financial-advisor`(3) · `agile`(3) · `pmbok`(3) · `pm`(3) · `security`(3) · `migration`(3) · `frontend`(3) · `backend-engineer`(3) · `frontend-engineer`(3) · `product-manager`(3) · `software-architect`(3) · `observability`(3) · `governance`(3) · `channel`(3) · `lifecycle`(2) · `privacy`(2) · `family-finance`(2) · `tax`(2) · `estate-planning`(2) · `CFP`(2) · `scrum-master`(2) · `api-design`(2) · `testing`(2) · `database`(2) · `indexing`(2) · `event-driven`(2) · `saga`(2) · `service-mesh`(2) · `react`(2) · `vue`(2) · `specification`(2) · `api-development`(2) · `web-development`(2) · `product-ownership`(2) · `cross-cutting`(2) · `credentials`(2) · `memory-search`(2) · `embedding`(2) · `tooling`(2) · `markdown`(2) · `error-handling`(2) · `compaction`(2) · `plugin`(2) · `context-window`(2) · `volcengine`(2) · `cron`(2) · `delivery`(2) · `adr-003`(2) · `review`(2) · `evidence`(2) · `index`(1) · `business-knowledge`(1) · `intake`(1) · `classification`(1) · `triage`(1) · `drafting`(1) · `template`(1) · `negotiation`(1) · `revision`(1) · `approval`(1) · `signature`(1) · `execution`(1) · `amendment`(1) · `change`(1) · `closure`(1) · `archive`(1) · `anti-corruption`(1) · `fcpa`(1) · `pipl`(1) · `gdpr`(1) · `dispute`(1) · `arbitration`(1) · `litigation`(1) · `china`(1) · `civil-code`(1) · `ip`(1) · `intellectual-property`(1) · `international`(1) · `cisg`(1) · `investment`(1) · `insurance`(1) · `will`(1) · `trust`(1) · `inheritance`(1) · `family-trust`(1) · `health-insurance`(1) · `medical-insurance`(1) · `critical-illness`(1) · `long-term-care`(1) · `life-insurance`(1) · `term-life`(1) · `whole-life`(1) · `increasing-life`(1) · `protection`(1) · `portfolio`(1) · `asset-allocation`(1) · `MPT`(1) · `strategic-allocation`(1) · `tactical-allocation`(1) · `retirement`(1) · `4-percent-rule`(1) · `annuity`(1) · `pension`(1) · `social-security`(1) · `risk-management`(1) · `VaR`(1) · `drawdown`(1) · `sharpe-ratio`(1) · `hedging`(1) · `enterprise-tax`(1) · `corporate-income-tax`(1) · `VAT`(1) · `SME-preferences`(1) · `individual-income-tax`(1) · `special-deduction`(1) · `annual-bonus`(1) · `guide`(1) · `knowledge-authoring`(1) · `role-definition`(1) · `hybrid`(1) · `tailoring`(1) · `kanban`(1) · `flow`(1) · `scrum`(1) · `framework`(1) · `performance-domains`(1) · `principles`(1) · `values`(1) · `processes`(1) · `practices`(1) · `risk`(1) · `assessment`(1) · `mitigation`(1) · `stakeholder`(1) · `engagement`(1) · `communication`(1) · `software-development`(1) · `sdlc`(1) · `full-stack`(1) · `rest`(1) · `graphql`(1) · `grpc`(1) · `openapi`(1) · `jwt`(1) · `oauth2`(1) · `rbac`(1) · `owasp`(1) · `authentication`(1) · `unit-test`(1) · `integration-test`(1) · `e2e`(1) · `contract-test`(1) · `postgresql`(1) · `mysql`(1) · `mongodb`(1) · `cqrs`(1) · `frontend-engineering`(1) · `vite`(1) · `ci-cd`(1) · `monorepo`(1) · `performance`(1) · `core-web-vitals`(1) · `lighthouse`(1) · `optimization`(1) · `hooks`(1) · `nextjs`(1) · `state-management`(1) · `pinia`(1) · `nuxt`(1) · `composition-api`(1) · `accessibility`(1) · `a11y`(1) · `wcag`(1) · `aria`(1) · `inclusive-design`(1) · `PRD`(1) · `product-requirements`(1) · `product-strategy`(1) · `business-model`(1) · `competition-analysis`(1) · `roadmap`(1) · `requirements`(1) · `user-stories`(1) · `use-case`(1) · `user-research`(1) · `persona`(1) · `journey-map`(1) · `usability-testing`(1) · `API`(1) · `REST`(1) · `GraphQL`(1) · `gRPC`(1) · `OpenAPI`(1) · `CQRS`(1) · `hexagonal`(1) · `DDD`(1) · `domain-modeling`(1) · `aggregate`(1) · `entity`(1) · `value-object`(1) · `domain-event`(1) · `service-decomposition`(1) · `circuit-breaker`(1) · `backend`(1) · `component-development`(1) · `product-discovery`(1) · `PM`(1) · `ADR`(1) · `technical-leadership`(1) · `layering`(1) · `foundation`(1) · `taxonomy`(1) · `organization`(1) · `self-hosted`(1) · `strategy`(1) · `logging`(1) · `tracing`(1) · `secrets`(1) · `persistence`(1) · `sqlite`(1) · `repository`(1) · `config`(1) · `snapshot`(1) · `drift-detection`(1) · `secret-redaction`(1) · `tools`(1) · `policy`(1) · `least-privilege`(1) · `silent-degradation`(1) · `memory`(1) · `semantic-search`(1) · `local-model`(1) · `fail-closed`(1) · `cross-layer`(1) · `contract`(1) · `runtime`(1) · `abstraction`(1) · `plug-and-play`(1) · `paradigm-shift`(1) · `session`(1) · `cleanup`(1) · `maintenance`(1) · `automation`(1) · `auto-heal`(1) · `self-recovery`(1) · `resilience`(1) · `model-scheduling`(1) · `reliability`(1) · `tavily`(1) · `tools-profile`(1) · `web-search`(1) · `git`(1) · `github`(1) · `model-switch`(1) · `ark-code-latest`(1) · `longcat`(1) · `ark`(1) · `glm`(1) · `minimax`(1) · `probe`(1) · `empirical`(1) · `automations`(1) · `wecom`(1) · `proactive-messaging`(1) · `platform-limit`(1) · `compatibility`(1) · `peer-dependency`(1) · `weixin`(1) · `third-party`(1) · `evaluation`(1) · `yagni`(1) · `documentation-drift`(1) · `adr`(1) · `confirmation-bias`(1) · `plugins-allow`(1) · `self-learning`(1) · `verification`(1) · `dry-run`(1) · `false-positive`(1) · `entitlement`(1) · `false-memory`(1) · `readiness`(1) · `export`(1) · `render`(1) · `portability`(1) · `goodhart`(1)
