...
from delivery_center.v1.db import init_db, executemany, query
from delivery_center.v1.collectors.data_cleaner import (
...
def run_pipeline(month: str, collect_only: bool = False, clean_only: bool = False):
    ...
    if not clean_only:
        ...
        # WeCom
        from delivery_center.v1.collectors.wecom_collector import collect_from_local
