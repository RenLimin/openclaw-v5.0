...
from delivery_center.v1.pipeline import run_pipeline
...
from delivery_center.v1.generators.approval_engine import generate_revenue_acceptance_summary
from delivery_center.v1.engines.join_engine import load_oa_contracts
from delivery_center.v1.engines.join_engine import (
...
def run_full_pipeline(month: str, report_only: bool = False, dry_run: bool = False) -> dict:
    ...
    try:
        from delivery_center.v1.collectors.ones_collector import load_ones_abnormal_projects
