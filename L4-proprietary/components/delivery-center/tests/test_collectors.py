...
def test_contract_no_calibration():
    """测试合同编号校准"""
    from delivery_center.v1.collectors.data_cleaner import calibrate_contract_no
...
def test_clean_ones_contract():
    """测试签约数据清洗"""
    from delivery_center.v1.collectors.data_cleaner import clean_ones_contract
...
def test_clean_ones_poc():
    """测试 POC 数据清洗"""
    from delivery_center.v1.collectors.data_cleaner import clean_ones_poc
...
def test_clean_workhour():
    """测试工时数据清洗"""
    from delivery_center.v1.collectors.data_cleaner import clean_workhour
...
def test_oa_collector_returns_none_when_no_browser():
    ...
    from delivery_center.v1.collectors.oa_collector import collect_contract_ledger_xlsx
