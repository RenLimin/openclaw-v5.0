...
- 预算 vs 实际差异计算（已验证 2026-09-01）
- 差异 = 签约金额 - 确收金额
- 差异分类：正常确收 / 差异确收（当年可消除）/ 提前确收
- 月度确收汇总（按合同归档月份）
- 验收汇总（按项目经理）

### 4.5 汇总统计引擎

- pivot_table 替代 Excel Pivot（已验证 2026-09-01）
- 按部门x状态、产品x类型、异常x影响 多维度统计
- 确收x部门汇总（含完成率）
- 工时x项目汇总
...
| 日期 | 版本 | 变更 |
|------|------|------|
| 2026-09-01 | v1.3 | M1~M5 全部完成 — BDMS 交付中心运营引擎 v1.0 发布 |
| 2026-09-01 | v1.2 | M1 全部完成 + M2 全部完成 + M3 交付月报完成 |
