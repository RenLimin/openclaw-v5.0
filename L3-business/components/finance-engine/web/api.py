...
def _get_services():
    """获取服务实例（延迟导入避免循环）"""
    from finance_engine.core.db import get_db
...
def add_integration(req: AddIntegrationRequest):
    from finance_engine.core.db import get_db
    from finance_engine.core.db.repositories import IntegrationRepository
    conn = get_db()
...
def add_import_rule(req: ImportRuleRequest):
    from finance_engine.core.db import get_db
    from finance_engine.core.services.import_svc import ImportService
    conn = get_db()
